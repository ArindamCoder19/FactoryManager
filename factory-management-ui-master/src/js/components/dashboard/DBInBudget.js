...
class DBInBudget extends React.Component {
  render () {
...
function mapStateToProps(state) {
  let { oit, mit, wit,
    overallIT, overallITD, lastMonthIT,
    lastMonthITD, lastWeekIT, lastWeekITD } = state.dashboard.dashboardData;
  return {
    overallPercentage: oit,
    lastMonthPercentage: mit,
    lastWeekPercentage: wit,
    overallDelivered: overallIT,
    overallTotal: overallITD,
    monthDelivered: lastMonthIT,
    monthTotal: lastMonthITD,
    weekDelivered: lastWeekIT,
    weekTotal: lastWeekITD
  };
}

export default connect(mapStateToProps, null)(DBInBudget);
